...
from app.services.dependencies import AsyncAzureAIClient, AzureAIClient, ConnectionManagerClient, EventHubClient, get_create_async_azure_ai_client, get_create_azure_ai_client, get_create_connection_manager, get_create_event_hub_client
...
async def on_event(partition_context, event):
    try:
        ...
        async_azure_ai_client = await get_create_async_azure_ai_client()
        ...
        #     async_client=async_azure_ai_client,
...
def start_alarm_event_listener():
    ...
    try:
        ...
        asyncio.create_task(receive_events(event_hub_client=event_hub_client))
